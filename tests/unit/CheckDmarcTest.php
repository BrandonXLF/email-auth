	...
	public function testMinimal() {
		...
		$this->assertEquals(
			[
				...
				'infos'    => [
					'<code>adkim</code>: DKIM domain and "From" domain need only share a common registered domain.',
					'<code>aspf</code>: Bounce domain and "From" domain need only share a common registered domain.',
				],
				'org'      => null,
				'orgFail'  => null,
				'relaxed'  => [
	...
	public function testStrictDKIM() {
		...
		$this->assertEquals(
			[
				...
				'infos'    => [
					'<code>adkim</code>: DKIM domain and "From" domain must be identical.',
					'<code>aspf</code>: Bounce domain and "From" domain need only share a common registered domain.',
				],
				'org'      => null,
				'orgFail'  => null,
	...
	public function testStrictAll() {
		...
		$this->assertEquals(
			[
				...
				'infos'    => [
					'<code>adkim</code>: DKIM domain and "From" domain must be identical.',
					'<code>aspf</code>: Bounce domain and "From" domain must be identical.',
				],
				'org'      => null,
				'orgFail'  => null,
				'relaxed'  => [
